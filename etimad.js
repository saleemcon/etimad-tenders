...
const TENDER_URL =
  "https://tenders.etimad.sa/Tender/AllTendersForVisitor?PageSize=6&IsSearch=true&PublishDateId=5&TenderCategory=2&Sort=SubmitionDate&SortDirection=DESC";
...
async function main() {
  ...
  // Save JSON
  await fs.writeJSON("tenders.json", tenders, { spaces: 2 });
